...
load_dotenv() # Load env vars from .env if it exists
...
SECRET_KEY = 'django-insecure-6(#uo3@sxn(^l%=c1y&ymbuqc=nf375(wg##v!p6eo%%jdfd&2'
...
# Parse DATABASE_URL if available (Supabase/Docker)
